...
var RewardHandler = /** @class */ (function () {
    ...
    var _a;
    _a = RewardHandler;
    RewardHandler.rewardAddEvent = function (event) { return __awaiter(void 0, void 0, void 0, function () {
        var data, found;
    ...
    RewardHandler.rewardRemoveEvent = function (event) { return __awaiter(void 0, void 0, void 0, function () {
        var data, found;
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0:
    ...
    RewardHandler.rewardUpdateEvent = function (event) { return __awaiter(void 0, void 0, void 0, function () {
        var data, found;
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0:
