...
var BanHandler = /** @class */ (function () {
    function BanHandler() {
    }
    var _a;
    _a = BanHandler;
    BanHandler.banEvent = function (event) { return __awaiter(void 0, void 0, void 0, function () {
        var data, found;
    ...
    BanHandler.unbanEvent = function (event) { return __awaiter(void 0, void 0, void 0, function () {
        var data, found;
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0:
