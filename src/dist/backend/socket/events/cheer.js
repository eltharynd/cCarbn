...
exports.CheerHandler = void 0;
var user_1 = require("../../db/models/user");
var socket_1 = require("../socket");
var toJSON_1 = require("./util/toJSON");
var CheerHandler = /** @class */ (function () {
    function CheerHandler() {
    }
    var _a;
    _a = CheerHandler;
    CheerHandler.cheerEvent = function (event) { return __awaiter(void 0, void 0, void 0, function () {
        var data, found;
...
exports.CheerHandler = CheerHandler;
